...
function Data() {
    ...
    const handleLogin = async (e) => {
        ...
        // console.log(body)
        try {
            let data = await fetch('https://teach-backened.vercel.app/admincheck', {
                method: 'POST',
                headers: {
    ...
    return (
        <div  >
            ...
            <Link  style={{marginTop:"10px",textDecoration:"none", color:"GrayText"}} to='/create'>Create An Account</Link>
                </div>
        </div>
    )
}
